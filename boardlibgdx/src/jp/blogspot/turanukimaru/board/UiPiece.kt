...
/**
 * 駒とLibGDXの間
 * touchDraggedで駒をドラッグしたいところだが、どうもドラッグはactorの座標と指の差分を出力しているらしくactorが移動するケースではまともに機能しないっぽい。
 * その場の絶対座標を取り直せば動きそうか？
...
//        uiBoard.board.pieceClick(position, piece)//盤に伝えると2重になるし盤は駒を意識しないし要らないか？
        this.x = 0f
        this.y = 0f
    }
