...
//TODO:一人目のキャラここから
        ...
        val piece1 = MyPiece(BattleUnit(BattleUnitRepository.getById("マルス")!!, 40), UiPiece(group, uiBoard!!), board!!, user)
...
//TODO:ここまで。なお現在の一覧画面から移動するようにした奴は別スレッドなのでRealmにアクセスすると落ちる。別インスタンスなら生きてるかな？
        ...
        val piece2 = MyPiece(BattleUnit(BattleUnitRepository.getById("ルキナ")!!, 40), UiPiece(stageDropletImage1, uiBoard!!), board!!, enemy)
