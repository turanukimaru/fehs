...
object StandardBaseHero {
    ...
    fun creates() {
        ...
        createItem("ルーク", 1, WeaponType.SWORD, MoveType.CAVALRY, "Luke", 5, 19, 8, 6, 8, 5, 7, 8, 6, 6, 3,
                Weapon.BraveSword2,null, Special.Boonfire, SkillA.FireBoost.lv(3), Skill.NONE, SkillC.PanicPloy.lv(3))
        ...
        createItem("チキ（大人）", 1, WeaponType.DRAGON, MoveType.INFANTRY, "Tiki(A)", 3, 18, 7, 6, 9, 7, 6, 9, 4, 8, 4,
                Weapon.LightningBreath2,null, Special.Boonfire, SkillA.DefiantAtk.lv(3), Skill.NONE, SkillC.SpurRes.lv(3))
        ...
        createItem("ルフレ（男）", 2, WeaponType.BTOME, MoveType.INFANTRY, "Robin(M)", 3, 18, 7, 7, 7, 5, 6, 6, 6, 6, 4,
                Weapon.Blarraven2,null, Special.Boonfire, SkillA.DefiantSpd.lv(3), Skill.NONE, SkillC.SpurDef.lv(3))
        ...
        createItem("マークス（夏）", 3, WeaponType.AXE, MoveType.INFANTRY, "Xander (Summer)", 5, 19, 8, 6, 8, 6, 7, 7, 7, 9, 1,
                Weapon.LilithFloatie2,null, Special.Boonfire, SkillA.FireBoost.lv(3), Skill.NONE, SkillC.InfantryPulse.lv(3))
