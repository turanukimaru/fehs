...
enum class Assist(override val jp: String, override val type: Skill.SkillType, override val level: Int = 0, override val preSkill: Skill = Skill.NONE) : Skill {
    ...
    Heal("ヒール", Skill.SkillType.ASSIST),
    Reconcile("", Skill.SkillType.ASSIST),
    Rehabilitate("", Skill.SkillType.ASSIST),
    Mend("", Skill.SkillType.ASSIST),
    Recover("", Skill.SkillType.ASSIST),
    Physic("", Skill.SkillType.ASSIST),
    Martyr("", Skill.SkillType.ASSIST),
