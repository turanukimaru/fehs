...
//    fun have(weaponType: WeaponType?, moveType: MoveType?): Boolean = (weaponType == null || this.weaponType == weaponType) && (moveType == null || this.moveType == moveType)
    ...
    fun clone(): BaseHero = BaseHero(
            color, weaponType, moveType, minRarity, name, hitPoint, attack, speed, defense, resistance, hpGrowth, atkGrowth, spdGrowth, defGrowth, resGrowth, weapon, assist, special, aSkill, bSkill, cSkill, refinedWeapon, seal
    )
}
