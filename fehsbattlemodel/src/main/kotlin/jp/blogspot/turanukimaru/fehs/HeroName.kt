...
enum class HeroName(val jp: String, val us: String, val tw: String) {
    ...
    カイネギス("カイネギス", "Caineghis", "Caineghis"),
    レテ("レテ", "Lethe", "Lethe"),
    モウディ("モウディ", "Mordecai", "Mordecai"),
    ライ("ライ", "Ranulf", "Ranulf"),
    フローラ__行楽_("フローラ（行楽）", "Flora (Picnics)", "芙洛拉 (Picnics)"),
    ...
    ベルクト__闇_("ベルクト（闇）", "Berkut (Darkness)", "貝爾克特 (Darkness)"),
    デューテ__闇_("デューテ（闇）", "Delthea (Darkness)", "迪優特 (Darkness)"),
    マリータ__闇_("マリータ（闇）", "Mareeta (Darkness)", "Mareeta (Darkness)"),
    フィヨルム__花嫁_("フィヨルム（花嫁）", "Fjorm (Bridal)", "菲約爾姆 (Bridal)"),
