...
enum class Name(val jp: String, val us: String, val tw: String) {
 ...
 カアラ("カアラ","Karla","卡菈"),
    ...
    FruitOfIdunn("","Fruit of Iðunn","Fruit of Iðunn"),
    AtkSpdPush("","Atk/Spd Push","Atk/Spd Push"),
    ShellLance("","Shell Lance","Shell Lance"),
    ShellLance2("","Shell Lance+","Shell Lance+"),
    DullClose("","Dull Close","Dull Close"),
    BeachBanner("","Beach Banner","Beach Banner"),
    BeachBanner2("","Beach Banner+","Beach Banner+"),
    Cocobow("","Cocobow","Cocobow"),
    Cocobow2("","Cocobow+","Cocobow+"),
    InfantryRush("","Infantry Rush","Infantry Rush"),
    ;
