...
enum class Name(val jp: String, val us: String, val tw: String) {
    ...
    ジャムカ("ジャムカ", "Jamke", "嘉姆卡"),
    フローラ("フローラ", "Flora", "芙洛拉"),
    HoarfrostKnife("霧氷のナイフ", "HoarfrostKnife", "霧冰匕首"),
    ...
    Gjoll("ギョッル", "", ""),
    FreezingSeal("", "", ""),
    GladiatorsBlade("", "Gladiator's Blade", ""),
    WhitewingBlade("", "Whitewing Blade", ""),
    WhitewingLance("", "Whitewing Lance", ""),
    WhitewingSpear("", "Whitewing Spear", ""),
    ScarletSword("", "Scarlet Sword", ""),
    TacticalGale("", "Tactical Gale", ""),
    TacticalBolt("", "Tactical Bolt", ""),
    TriangleAttack("", "Triangle Attack", "Triangle Attack"),
    ;
