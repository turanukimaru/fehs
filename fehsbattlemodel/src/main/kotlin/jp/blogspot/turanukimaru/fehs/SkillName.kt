...
enum class SkillName(val jp: String, val us: String, val tw: String) {
    ...
    RallyAtkSpd2("攻撃守速さの応援＋", "Rally Atk/Spd+", "攻擊速度支援＋"),
    ...
    WhitewingBlade("白騎の長剣", "Whitewing Blade", "Whitewing Blade"),
    WhitewingLance("白騎の直槍", "Whitewing Lance", "Whitewing Lance"),
    WhitewingSpear("白騎の短槍", "Whitewing Spear", ""),
    ...
    JoyousLantern("","Joyous Lantern",""),
    JoyousLantern2("","Joyous Lantern+",""),
    AtkOpening("","Atk Opening",""),
    GlitteringBreath("","Glittering Breath",""),
    GlitteringBreath2("","Glittering Breath+",""),
    FestiveSiegmund("","Festive Siegmund",""),
    GoodieBoot("","Goodie Boot",""),
    GoodieBoot2("","Goodie Boot+",""),
    ;
