...
enum class SkillName(val jp: String, val us: String, val tw: String) {
    ...
    ItsCurtains("暖簾", "It's Curtains...", ""),
    ItsCurtains2("暖簾＋", "It's Curtains...+", ""),
    RedHotDucks("", "Red-Hot Ducks", ""),
    RedHotDucks2("", "Red-Hot Ducks+", ""),
    Grandscratcher("", "Grandscratcher", ""),
    Grandscratcher2("", "Grandscratcher", ""),
    FirefloodBalm("", "Fireflood Balm", ""),
    FirefloodBalm2("", "Fireflood Balm+", ""),
    SplashyBucket("", "Splashy Bucket", ""),
    SplashyBucket2("", "Splashy Bucket+", ""),
    AirOrders("", "Air Orders", ""),
    OuchPouch("", "Ouch Pouch", ""),
    OuchPouch2("", "Ouch Pouch+", ""),
