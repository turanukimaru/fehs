...
object StandardBaseHero {
    ...
    private fun creates() {
        ...
        createItem(Name.カタリナ2, 1, WeaponType.RTOME, MoveType.INFANTRY, 5, 17, 6, 8, 5, 8, 4, 8, 8, 1, 7,
                Weapon.ReesesTome, null, Special.Glacies, SkillA.SwiftSparrow.lv(2), null, SkillC.AtkPloy.lv(3))
        ...
        createItem(Name.ネフェニー2, 2, WeaponType.LANCE, MoveType.INFANTRY, 5, 18, 7, 9, 8, 5, 5, 7, 8, 8, 3,
                Weapon.DauntlessLance, null, Special.Moonbow, SkillA.AtkSpd.lv(2), SkillB.Wrath.lv(3), null)
        ...
        createItem(Name.オーディン2, 2, WeaponType.BTOME, MoveType.INFANTRY, 3, 19, 5, 8, 6, 6, 7, 4, 7, 5, 5,
                Weapon.OdinsGrimoire, null, Special.Moonbow, SkillA.DefiantAtk.lv(3), SkillB.RTomeBreaker.lv(3), null)
        ...
        createItem(Name.カミラ2, 3, WeaponType.AXE, MoveType.FLIER, 4, 18, 8, 8, 6, 7, 5, 6, 7, 6, 7,
                Weapon.CamillasAxe, null, Special.DraconicAura, SkillA.DartingBlow.lv(3), null, SkillC.SavageBlow.lv(3))
        ...
        createItem(Name.セルジュ2, 3, WeaponType.AXE, MoveType.FLIER, 3, 20, 10, 6, 8, 3, 8, 9, 5, 7, 2,
                Weapon.CherchesAxe, Assist.Pivot, null, SkillA.Attack.lv(3), null, SkillC.FortifyDef.lv(3))
        ...
        createItem(Name.ティアマト2, 3, WeaponType.AXE, MoveType.CAVALRY, 5, 18, 6, 8, 6, 8, 5, 6, 8, 5, 6,
                Weapon.DraconicPoleax, Assist.ReciprocalAid, null, SkillA.ArmoredBlow.lv(3), SkillB.Guard.lv(3), null)
        ...
        createItem(Name.チキ__幼夏_, 1, WeaponType.DRAGON, MoveType.FLIER, 5, 16, 7, 4, 8, 4, 7, 8, 11, 7, 6,
                Weapon.SummersBreath, null, Special.Moonbow, SkillA.AtkDefBond.lv(3), SkillB.HitAndRun, SkillC.DragonValor.lv(3))
        createItem(Name.カミラ__夏_, 2, WeaponType.BTOME, MoveType.FLIER, 5, 17, 7, 10, 6, 7, 6, 8, 8, 4, 3,
                Weapon.JuicyWave2, null, Special.DraconicAura, SkillA.DeathBlow.lv(3), SkillB.FlierFormation.lv(3), SkillC.HoneFliers)
        ...
        createItem(Name.ヘクトル__総選挙_, 2, WeaponType.LANCE, MoveType.ARMORED, 5, 24, 11, 5, 9, 6, 7, 8, 4, 10, 6,
                Weapon.Maltet, null, Special.Ignis, SkillA.OstianCounter, SkillB.BoldFighter.lv(3), SkillC.EvenResWave.lv(3))
        ...
        createItem(Name.フローラ, 1, WeaponType.DAGGER, MoveType.INFANTRY, 5, 16, 8, 6, 5, 10, g50, g60, g40, g30, g65,
                Weapon.HoarfrostKnife, null, Special.Iceberg, SkillA.AtkResSolo.lv(3), SkillB.QuickRiposte.lv(3), SkillC.DefPloy.lv(3))
        ...
        createItem(Name.レーギャルン, 1, WeaponType.SWORD, MoveType.FLIER, 5, 17, 8, 10, 8, 4, g55, g55, g60, g65, g30,
                Weapon.Niu, null, Special.Bonfire, SkillA.RDuelFlying.lv(3), SkillB.ChillAtk.lv(3), SkillC.DistantGuard.lv(3))
