...
object StandardBaseHero {
    ...
    fun creates() {
        ...
        createItem(Name.ヨシュア, 1, WeaponType.SWORD, MoveType.INFANTRY,  5, 18, 7, 9, 8, 6, 6, 7, 8, 6, 6,
        ...
        createItem(Name.ソレイユ, 1, WeaponType.SWORD, MoveType.INFANTRY,  5, 18, 10, 9, 6, 5, 5, 9, 8, 6, 5,
    ...
    private fun createItem(
        ...
        val item = BaseHero(color, weaponType, moveType, minRarity, name, hp, atk, spd, def, res, hpgrowth, atkgrowth, spdgrowth, defgrowth, resgrowth, weapon ?: Skill.NONE, assist ?: Skill.NONE, special ?: Skill.NONE, aSkill, bSkill, cSkill)
        ITEMS.add(item)
