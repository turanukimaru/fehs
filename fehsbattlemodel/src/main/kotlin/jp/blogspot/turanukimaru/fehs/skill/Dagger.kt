...
enum class Dagger(override val jp: Name, override val type: SkillType, override val level: Int = 0, override val preSkill: Skill = Skill.NONE, override val spType: SpType = SpType.LEGEND_W, override val refinedWeaponType: RefinedWeapon.RefineType = RefinedWeapon.RefineType.NONE, override val effectiveAgainstMoveType: Array<MoveType> = arrayOf(), override val effectiveAgainstWeaponType: Array<WeaponType> = arrayOf()) : Weapon {
    ...
    SilverDagger2(Name.SilverDagger2, SkillType.DAGGER, 10, SilverDagger, SpType.PLUS, RefinedWeapon.RefineType.Range2),
    RogueDagger(Name.RogueDagger, SkillType.DAGGER, 4, SteelDagger, SpType.SILVER),
    RogueDagger2(Name.RogueDagger2, SkillType.DAGGER, 7, RogueDagger, SpType.PLUS, RefinedWeapon.RefineType.Range2),
    SmokeDagger(Name.SmokeDagger, SkillType.DAGGER, 6, SteelDagger, SpType.SILVER),
    SmokeDagger2(Name.SmokeDagger2, SkillType.DAGGER, 9, SmokeDagger, SpType.PLUS, RefinedWeapon.RefineType.Range2),
    ...
    Seashell2(Name.Seashell2, SkillType.DAGGER, 10, Seashell, SpType.PLUS, RefinedWeapon.RefineType.Range2) {
        override fun localFightEffect(battleUnit: BattleUnit, enemy: BattleUnit, lv: Int): BattleUnit = fullHpBonus(battleUnit, 2)
    },
    DancersFan(Name.DancersFan, SkillType.DAGGER, 7, SteelDagger, SpType.SILVER),
    DancersFan2(Name.DancersFan2, SkillType.DAGGER, 10, DancersFan, SpType.PLUS, RefinedWeapon.RefineType.Range2),
    DeathlyDagger(Name.DeathlyDagger, SkillType.DAGGER, 11, SilverDagger, SpType.LEGEND_W, RefinedWeapon.RefineType.Range2) {
    ...
    KagamiMochi2(Name.KagamiMochi2, SkillType.DAGGER, 12, KagamiMochi, SpType.PLUS, RefinedWeapon.RefineType.Range2) {
        override fun localEquip(armedHero: ArmedHero, lv: Int): ArmedHero = equipKiller(armedHero, lv)
    },
    FeliciasPlate(Name.FeliciasPlate, SkillType.PENETRATE_DAGGER, 14, SilverDagger2, SpType.LEGEND_W, RefinedWeapon.RefineType.Range2),
    ...
    LethalCarrot2(Name.LethalCarrot2, SkillType.DAGGER, 12, LethalCarrot, SpType.PLUS, RefinedWeapon.RefineType.Range2) {
        override fun specialTriggered(battleUnit: BattleUnit, damage: Int): Int = damage + 10
    },
    BarbShuriken(Name.BarbShuriken, SkillType.DAGGER, 8, SteelDagger, SpType.SILVER) {
        override fun localEquip(armedHero: ArmedHero, lv: Int): ArmedHero = equipKiller(armedHero, lv)
    },
    BarbShuriken2(Name.BarbShuriken2, SkillType.DAGGER, 12, BarbShuriken, SpType.PLUS, RefinedWeapon.RefineType.Range2) {
        override fun localEquip(armedHero: ArmedHero, lv: Int): ArmedHero = equipKiller(armedHero, lv)
    },
    ...
    TheCleaner2(Name.TheCleaner2, SkillType.DAGGER, 12, TheCleaner, SpType.PLUS, RefinedWeapon.RefineType.Range2) {
        override fun stateFlat(battleUnit: BattleUnit, enemy: BattleUnit): Int = enemy.totalBuff
    },
    ...
    Starfish2(Name.Starfish2, SkillType.DAGGER, 12, Starfish, SpType.PLUS, RefinedWeapon.RefineType.Range2) {
        override fun attackPlan(fightPlan: FightPlan, lv: Int): FightPlan = desperation(fightPlan, 3)
    },
    ...
    CloudMaiougi2(Name.CloudMaiougi2, SkillType.DAGGER, 12, CloudMaiougi, SpType.PLUS, RefinedWeapon.RefineType.Range2, effectiveAgainstWeaponType = arrayOf(WeaponType.DRAGON)) {
        override fun localFightEffect(battleUnit: BattleUnit, enemy: BattleUnit, lv: Int): BattleUnit = hardyBearing(battleUnit, enemy, 3)
    },
    ...
    SkyMaiougi2(Name.SkyMaiougi2, SkillType.DAGGER, 12, SkyMaiougi, SpType.PLUS, RefinedWeapon.RefineType.Range2, effectiveAgainstMoveType = arrayOf(MoveType.ARMORED)) {
        override fun localFightEffect(battleUnit: BattleUnit, enemy: BattleUnit, lv: Int): BattleUnit = hardyBearing(battleUnit, enemy, 3)
    },
    ...
    DuskUchiwa2(Name.SkyMaiougi2, SkillType.DAGGER, 12, DuskUchiwa, SpType.PLUS, RefinedWeapon.RefineType.Range2, effectiveAgainstMoveType = arrayOf(MoveType.CAVALRY)) {
        override fun localFightEffect(battleUnit: BattleUnit, enemy: BattleUnit, lv: Int): BattleUnit = hardyBearing(battleUnit, enemy, 3)
    },
