...
class fightTestA {
    ...
    fun noSkillSpeedTestB() {
        val unitA = StandardBattleClass.get("マルス（仮面）")!!
        val kazahanaA = StandardBattleClass.get("カザハナ")!!
    ...
    fun noSkillSpeedTestC() {
        ...
        val grayA = StandardBattleClass.get("グレイ")!!
    ...
    fun noBravTestA() {
        val unitA = StandardBattleClass.get("マルス（仮面）")!!
        val dogaA = StandardBattleClass.get("ドーガ")!!
    ...
    @Test
    fun bravTestB() {
        val unitA = StandardBattleClass.get("エリンシア")!!
        val dogaA = StandardBattleClass.get("ドーガ")!!
        val fightResult =BattleUnit(unitA, unitA.maxHp).fight( BattleUnit(dogaA, dogaA.maxHp))
        println(fightResult[0])
        assertEquals("attack side fail", SIDES.ATTACKER, fightResult[0].side)
...
@Test
    fun vantageTestA() {
        val unitA = StandardBattleClass.get("ルーナ")!!
        val unitB = StandardBattleClass.get("ロンクー")!!
    ...
    fun desperationTestA() {
        val unitA = StandardBattleClass.get("アルム")!!
        val unitB = StandardBattleClass.get("シャニー")!!
        val fightResult = BattleUnit(unitB, unitB.maxHp*3/4).fight(BattleUnit(unitA, unitA.maxHp))
        println(fightResult[0])
        assertEquals("attack side fail", fightResult[0].side, SIDES.ATTACKER)
    ...
    fun desperationTestC() {
        val unitA = StandardBattleClass.get("グレイ")!!
        val unitB = StandardBattleClass.get("シャニー")!!
    ...
    fun QuickRiposteTestA() {
        val unitA = StandardBattleClass.get("ツバキ")!!
        val unitB = StandardBattleClass.get("シャニー")!!
    ...
    fun QuickRiposteTestB() {
        val unitA = StandardBattleClass.get("クレイン")!!
        val unitB = StandardBattleClass.get("オルエン")!!
        val fightResult = BattleUnit(unitB, unitB.maxHp).fight(BattleUnit(unitA, unitA.maxHp))
        println(fightResult[0])
        assertEquals("attack side fail", fightResult[0].side, SIDES.ATTACKER)
        assertEquals("damage fail", 11, fightResult[0].damage)
    ...
    fun brashAssaultTestA() {
        val unitA = StandardBattleClass.get("ヒナタ")!!
        val unitB = StandardBattleClass.get("マルス")!!
    ...
    fun brashAssaultTestC() {
        val unitB = StandardBattleClass.get("ヒナタ")!!
        val unitA = StandardBattleClass.get("マルス")!!
