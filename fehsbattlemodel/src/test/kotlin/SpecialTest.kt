...
class SpecialTest {
    ...
    fun noontimeTest() {
        ...
        Assert.assertEquals("buildDamage fail", 14, fightResult[2].damage)
        ...
        Assert.assertEquals("buildDamage fail", 7, fightResult[3].damage)
        ...
        Assert.assertEquals("buildDamage fail", 14, fightResult[4].damage)
        ...
        Assert.assertEquals("buildDamage fail", 14, fightResult[5].damage)
    ...
    fun solTest() {
        ...
        println(fightResult[4])
        Assert.assertEquals("attack side fail", fightResult[4].side, SIDES.ATTACKER)
        Assert.assertEquals("buildDamage fail", 12, fightResult[4].damage)
    ...
    fun regnalAstraTest() {
        ...
        println(fightResult[1])
        Assert.assertEquals("attack side fail", fightResult[1].side, SIDES.ATTACKER)
        Assert.assertEquals("buildDamage fail", 18, fightResult[1].damage)
        ...
        println(fightResult[3])
        Assert.assertEquals("attack side fail", fightResult[3].side, SIDES.ATTACKER)
        Assert.assertEquals("buildDamage fail", 18, fightResult[3].damage)
    ...
    fun draconicAuraTest() {
        ...
        println(fightResult[3])
        Assert.assertEquals("attack side fail", fightResult[3].side, SIDES.ATTACKER)
        Assert.assertEquals("buildDamage fail", 13, fightResult[3].damage)
        ...
        println(fightResult[4])
        Assert.assertEquals("attack side fail", fightResult[4].side, SIDES.ATTACKER)
        Assert.assertEquals("buildDamage fail", 7, fightResult[4].damage)
    ...
    fun dragonFangTest() {
        ...
        println(fightResult[2])
        Assert.assertEquals("attack side fail", fightResult[2].side, SIDES.ATTACKER)
        Assert.assertEquals("buildDamage fail", 46, fightResult[2].damage)
    ...
    fun bonfireTest() {
        ...
        Assert.assertEquals("buildDamage fail", 51, fightResult[3].damage)
    ...
    fun ignisTest() {
        ...
        println(fightResult[1])
        Assert.assertEquals("attack side fail", fightResult[1].side, SIDES.ATTACKER)
        Assert.assertEquals("buildDamage fail", 39, fightResult[1].damage)
    ...
    fun icebergTest() {
        ...
        println(fightResult[2])
        Assert.assertEquals("attack side fail", fightResult[2].side, SIDES.ATTACKER)
        Assert.assertEquals("buildDamage fail", 26, fightResult[2].damage)
    ...
    fun aetherTest() {
        ...
        println(fightResult[1])
        Assert.assertEquals("attack side fail", fightResult[1].side, SIDES.ATTACKER)
        Assert.assertEquals("buildDamage fail", 37, fightResult[1].damage)
    ...
    fun moonbowTest() {
        ...
        println(fightResult[1])
        Assert.assertEquals("attack side fail", fightResult[1].side, SIDES.COUNTER)
        Assert.assertEquals("buildDamage fail", 4, fightResult[1].damage)
        Assert.assertEquals("hitPoint fail", 41, fightResult[1].source.hp)
        Assert.assertEquals("hitPoint fail", 40, fightResult[1].target.hp)
        println(fightResult[2])
        Assert.assertEquals("attack side fail", fightResult[2].side, SIDES.ATTACKER)
        Assert.assertEquals("buildDamage fail", 32, fightResult[2].damage)
        ...
        println(fightResult[3])
        Assert.assertEquals("attack side fail", fightResult[3].side, SIDES.COUNTER)
        Assert.assertEquals("buildDamage fail", 4, fightResult[3].damage)
        Assert.assertEquals("hitPoint fail", 37, fightResult[3].source.hp)
    ...
    fun lunaTest() {
        ...
        println(fightResult[3])
        Assert.assertEquals("attack side fail", fightResult[3].side, SIDES.COUNTER)
        Assert.assertEquals("buildDamage fail", 1, fightResult[3].damage)
        Assert.assertEquals("hitPoint fail", 37, fightResult[3].source.hp)
    ...
    fun blackLunaTest() {
        ...
        println(fightResult[2])
        Assert.assertEquals("attack side fail", fightResult[2].side, SIDES.ATTACKER)
        Assert.assertEquals("buildDamage fail", 41, fightResult[2].damage)
    ...
    fun reprisalTest() {
        ...
        println(fightResult[3])
        Assert.assertEquals("attack side fail", fightResult[3].side, SIDES.COUNTER)
        Assert.assertEquals("buildDamage fail", 17, fightResult[3].damage)
        Assert.assertEquals("hitPoint fail", 13, fightResult[3].source.hp)
    ...
    fun miracleTest() {
        ...
        println(fightResult[1])
        Assert.assertEquals("attack side fail", fightResult[1].side, SIDES.COUNTER)
        Assert.assertEquals("buildDamage fail", 32, fightResult[1].damage)
    ...
    fun sacredCowlTest() {
        ...
        println(fightResult[1])
        Assert.assertEquals("attack side fail", fightResult[1].side, SIDES.ATTACKER)
        Assert.assertEquals("buildDamage fail", 10, fightResult[1].damage)
        Assert.assertEquals("hitPoint fail", 39, fightResult[1].source.hp)
